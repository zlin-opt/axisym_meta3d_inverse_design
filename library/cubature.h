...
typedef PetscInt (*integrand) (unsigned ndim, const PetscReal *x, void *,
...
typedef PetscInt (*integrand_v) (unsigned ndim, size_t npt,
				 const PetscReal *x, void *,
				 unsigned fdim, PetscReal *fval);
...
PetscInt hcubature_v(unsigned fdim, integrand_v f, void *fdata,
		     unsigned dim, const PetscReal *xmin, const PetscReal *xmax, 
		     size_t maxEval, PetscReal reqAbsError, PetscReal reqRelError, 
		     error_norm norm,
		     PetscReal *val, PetscReal *err);
